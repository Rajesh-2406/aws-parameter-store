...
*/
   ...
   { name = "roboshop.dev.catalogue.mongo_url", value = "mongodb://roboshop:@docdb-dev-0.c2cprqmiz9av.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&tlsCAFile=global-bundle.pem&retryWrites=false", type = "String" },
