...
variable "params"{
 default  = [
   ...
   { name = "roboshop.dev.cart.redis_host", value = "elasticache-dev.vxqnh7.clustercfg.use1.cache.amazonaws.com:6379", type = "String" },
   ...
   { name = "roboshop.dev.user.redis_host", value = "elasticache-dev.vxqnh7.clustercfg.use1.cache.amazonaws.com:6379", type = "String"},
/*
...
*/
   ...
   { name = "roboshop.dev.catalogue.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-c2cprqmiz9av.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&tlsCAFile=global-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
   ...
   { name = "roboshop.dev.user.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-c2cprqmiz9av.us-east-1.docdb.amazonaws.com:27017/users?tls=true&tlsCAFile=global-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
...
{ name = "roboshop.prod.cart.redis_host", value = "elasticache-dev.vxqnh7.clustercfg.use1.cache.amazonaws.com:6379", type = "String" },
...
{ name = "roboshop.prod.user.redis_host", value = "elasticache-dev.vxqnh7.clustercfg.use1.cache.amazonaws.com:6379", type = "String"},
/*
   { name = "roboshop.dev.user.mongo_url", value = "mongodb://mongodb-dev.devops2406.xyz/users", type = "String" },
*/
...
{ name = "roboshop.prod.mysql.endpoint", value = "rds-dev.cluster-c2cprqmiz9av.us-east-1.rds.amazonaws.com", type = "String" },
...
{ name = "roboshop.prod.catalogue.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-c2cprqmiz9av.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&tlsCAFile=global-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
{ name = "roboshop.prod.catalogue.docdb_endpoint",value ="docdb-dev.cluster-c2cprqmiz9av.us-east-1.docdb.amazonaws.com", type = "String" },

{ name = "roboshop.prod.user.docdb_endpoint",value ="docdb-dev.cluster-c2cprqmiz9av.us-east-1.docdb.amazonaws.com", type = "String" },
{ name = "roboshop.prod.user.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-c2cprqmiz9av.us-east-1.docdb.amazonaws.com:27017/users?tls=true&tlsCAFile=global-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
