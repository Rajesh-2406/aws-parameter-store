resource "aws_ssm_parameter" "params" {
 ...
 value      = var.params[count.index].value
  overwrite = true
  key_id    = "391d5412-55a3-4072-89de-fca5ccc4c9f3"
}
...
variable "params"{
 default  = [
   ...
   { name = "roboshop.dev.cart.redis_host", value = "elasticache-dev.ajrcky.clustercfg.use1.cache.amazonaws.com:6379", type = "String" },
   ...
   { name = "roboshop.dev.user.redis_host", value = "elasticache-dev.ajrcky.clustercfg.use1.cache.amazonaws.com:6379", type = "String"},
/*
...
*/
   ...
   { name = "roboshop.dev.mysql.endpoint", value = "rds-dev.cluster-crpaxg4qag9m.us-east-1.rds.amazonaws.com", type = "String" },
   ...
   { name = "roboshop.dev.catalogue.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-crpaxg4qag9m.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&tlsCAFile=global-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
   { name = "roboshop.dev.catalogue.docdb_endpoint",value ="docdb-dev.cluster-crpaxg4qag9m.us-east-1.docdb.amazonaws.com", type = "String" },
   { name = "roboshop.dev.user.docdb_endpoint",value ="docdb-dev.cluster-crpaxg4qag9m.us-east-1.docdb.amazonaws.com", type = "String" },
   { name = "roboshop.dev.user.mongo_url", value = "mongodb://roboshop:roboshop123@docdb-dev.cluster-crpaxg4qag9m.us-east-1.docdb.amazonaws.com:27017/users?tls=true&tlsCAFile=global-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "SecureString" },
...
{ name = "roboshop.prod.cart.redis_host", value = "eelasticache-prod.ajrcky.clustercfg.use1.cache.amazonaws.com:6379", type = "String" },
...
{ name = "roboshop.prod.user.redis_host", value = "elasticache-prod.ajrcky.clustercfg.use1.cache.amazonaws.com:6379", type = "String"},
/*
   { name = "roboshop.dev.user.mongo_url", value = "mongodb://mongodb-dev.devops2406.xyz/users", type = "String" },
*/
...
{ name = "roboshop.prod.mysql.endpoint", value = "rds-prod.cluster-crpaxg4qag9m.us-east-1.rds.amazonaws.com", type = "String" },
